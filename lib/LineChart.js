...
import GetOffsetEnhancer from "./GetOffsetEnhancer";
...
var RNLineChart = requireNativeComponent("RNLineChart", LineChart, {
  nativeOnly: { onSelect: true, onChange: true, onChangeOffset: true }
});

export default ScrollEnhancer(
  GetOffsetEnhancer(HighlightEnhancer(ScaleEnhancer(MoveEnhancer(LineChart))))
);
